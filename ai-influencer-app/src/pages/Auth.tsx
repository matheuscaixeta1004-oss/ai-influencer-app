      ...
      <div className="hidden lg:block w-[45%] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-10">
          ...
          <p className="text-[15px] text-white/60 mt-3 max-w-[360px] leading-relaxed">
            Crie modelos virtuais ultra-realistas. Gere milhares de fotos consistentes. Construa uma audiência.
          </p>
          <div className="flex items-center gap-6 mt-6">
            {[
              { value: '50K+', label: 'Modelos' },
              { value: '2.4M', label: 'Fotos' },
            ...
            >
              ...
              <p className="text-[15px] text-gray-400 mt-2 mb-8">
                {mode === 'login'
                  ...
                  : 'Comece com 50 créditos grátis. Sem cartão de crédito.'}
              </p>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[12px] text-gray-300 uppercase tracking-wider">ou</span>
                <div className="flex-1 h-px bg-gray-100" />
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {mode === 'register' && (
                  <div>
                    <label className="block text-[13px] font-medium text-black mb-1.5">Nome completo</label>
                    <input
                      type="text"
                      value={name}
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="text-[13px] font-medium text-black">Senha</label>
                    {mode === 'login' && (
                ...
                {mode === 'register' && (
                  <div>
                    <label className="block text-[13px] font-medium text-black mb-1.5">Confirmar senha</label>
                    <input
                      type="password"
